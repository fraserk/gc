  ...
  var mapOptions = {
    center: new google.maps.LatLng(40.731693, -73.98928599999999),
    zoom: defaultZoom,
  ...
  var map = new google.maps.Map(document.getElementById('map'),mapOptions);
	...
	// '13.731547730050778'
	// '100.56798934936523'
	var mylat = document.getElementById("event_location_attributes_lat").value;
	var mylng = document.getElementById("event_location_attributes_lng").value;
	if (jQuery.isEmptyObject(mylat)) {
	  var mylat = '40.731693';
	  var mylng = '-73.98928599999999';
  ...
  autocomplete.bindTo('bounds', map);
	...
	google.maps.event.addListener(marker, "dragend", function() {
		...
		map.panTo(point);
		document.getElementById("event_location_attributes_lat").value = point.lat();
		document.getElementById("event_location_attributes_lng").value = point.lng();
		infowindow.close();
    marker.setIcon(defaultImage);
  });
  ...
  google.maps.event.addListener(autocomplete, 'place_changed', function() {
    ...
    map.setZoom(16);
		document.getElementById("event_location_attributes_lat").value = place.geometry.location.lat();
		document.getElementById("event_location_attributes_lng").value = place.geometry.location.lng();
    ...
    document.getElementById("event_location_attributes_zipcode").value = zipcode;
    document.getElementById("event_location_attributes_city").value = city;
    document.getElementById("event_location_attributes_country").value = country;
    document.getElementById("event_location_attributes_state").value = sublocality;
    document.getElementById("event_location_attributes_address").value = formatted_address;
    document.getElementById("event_location_attributes_location_name").value = location_name;
    document.getElementById("event_location_attributes_phone_number").value = formatted_phone_number;
