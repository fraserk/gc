# RailsAdmin config file. Generated on May 12, 2012 11:33
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Events', 'Admin']
  ...
  # config.excluded_models = [Event, Location, Schedule, User, Venue]

  # Add models here if you want to go 'whitelist mode':
   config.included_models = [Event, Location, User, Venue]
  ...
  #     configure :fee, :string 
  #     configure :when, :datetime 
  #     configure :detail, :text 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :flyer, :carrierwave 
  #     configure :user_id, :integer         # Hidden 
  #     configure :expire, :boolean 
  #     configure :recurr, :boolean 
  #     configure :location_id, :integer         # Hidden 
  #     configure :slug, :string 
  #     configure :event_date, :date   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
